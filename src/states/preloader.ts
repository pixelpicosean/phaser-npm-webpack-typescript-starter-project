...
export default class Preloader extends Phaser.State {
  ...
  public preload(): void {
    this.preloadBarSprite = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, Assets.Atlases.PreloadSprites.getName(), Assets.Atlases.PreloadSprites.Frames.PreloadBar);
    this.preloadBarSprite.anchor.setTo(0, 0.5);
    this.preloadBarSprite.x -= this.preloadBarSprite.width * 0.5;

    this.preloadFrameSprite = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, Assets.Atlases.PreloadSprites.getName(), Assets.Atlases.PreloadSprites.Frames.PreloadFrame);
